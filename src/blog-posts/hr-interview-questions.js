export default {
  ...
  content: [
    ...
    `120- Suggest a training program/workshop for feedback skills?`,
    `121- How do you justify the job?`,
    `122- If you had a chance to make a change, what would you do differently?`,
    `123- How do you feel about drug tests?`,
    `124- How do you feel about psychological tests?`,
    `125- Do you prefer a job with clearly defined tasks, or one that is more self-directed?`,
    `126- Are you open to experimenting and undertaking risks?`,
    `127- You do not have all the experience for this position or How do you compensate for your lack of experience for this position?`,
    `128- How quickly do you adapt to new technology?`,
    `129- If someone told you that you made an error, describe how you would react and what you say in your defense.`,
    `130- What kind of problems have people recently called on you to resolve?  Tell us what you have devised.`
  ],
  link: '',
};
